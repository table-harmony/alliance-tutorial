...
namespace WebApplication1.Utils {
    ...
    /// Made by https://github.com/RahulTandon1
    /// </summary>
        ...
        public static Bitmap Encode(string text, Bitmap bmp) {
            ...
            for (int i = 0; i < bmp.Height; i++) {
                ...
                for (int j = 0; j < bmp.Width; j++) {
                    ...
                    redByte = pixel.R - pixel.R % 2;
                    greenByte = pixel.G - pixel.G % 2;
                    blueByte = pixel.B - pixel.B % 2;
                        ...
                        if (pixelElementIndex % 8 == 0) {
                            ...
                            if (state == State.Filling_With_Zeros && zeros == 8) {
                                ...
                                if ((pixelElementIndex - 1) % 3 < 2) {
                                    bmp.SetPixel(j, i, Color.FromArgb(redByte, greenByte, blueByte));
                                }
